		...
		?>
			...
			<div id="pagina" >
				...
				<div id="principal" class="div">
					<h1 class="h1">Alumnos Inscritos en Ofertas de Empleo</h1>
					<div class="tabla">	
						<?php	
							
							$conexion=mysqli_connect("localhost","root","","bolsaempleo") or die("Problemas en la conexion");
							$query= "SELECT * FROM ALUMNOS WHERE DNI IN (select DISTINCT DNI from INSCRITOS where DNI IN (SELECT  DNI FROM ALUMNOS WHERE IDPROF=$sesion))"
						  ...
						  if ($nfilas > 0)
						  {
							 ...
							 print ("<P class=\"pp\">No hay ALUMNOS inscritos en Ofertas de Empleo</p>");
