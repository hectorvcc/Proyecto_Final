							...
							<?PHP
							  ...
							  if ($nfilas > 0)
							  {
								 ...
								 for ($i=0; $i<$nfilas; $i++)
								 {
									...
									print "<td><a href=\"modif_empresa.php?CIF=".$fila['CIF']."\"> <img id=\"estado\" src=\"/Proyecto/botones/inscripcion-2.gif\"> </a></td>
											<td><a href=\"baja_empresa.php?CIF=".$fila['CIF']."\"> <img id=\"estado\" src=\"/Proyecto/botones/darse-de-baja.gif\"> </a></td>";
									print ("</TR>\n");
								 }
